...
const CKCP027 string = "CKCP027 Failed to create HTTP POST request for JWT authentication: %v"
const CKCP028 string = "CKCP028 Failed to get response from JWT authenticator: %v"
const CKCP029 string = "CKCP029 Failed to authenticate: %v"
...
const CKCP037 string = "CKCP037 Failed to get kubeconfig: %v"
const CKCP038 string = "CKCP038 Failed to configure k8s client: %v"
